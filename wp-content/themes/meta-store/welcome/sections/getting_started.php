    ...
    <div class="upgrade-demo-wrap">
        <div class="recommend-plugins">
            <div class="plug-image">
                <img src="http://mysticalthemes.com/import/meta-store/screen/shoes-screenshot.png" alt="<?php echo esc_attr__('Meta Store Demos', 'meta-store'); ?>">
            </div>
        ...
        <div class="recommend-plugins">
            <div class="plug-image">
                <img src="http://mysticalthemes.com/import/meta-store/screen/jewels-screenshot.png" alt="<?php echo esc_attr__('Meta Store Demos', 'meta-store'); ?>">
            </div>
        ...
        <div class="recommend-plugins">
            <div class="plug-image">
                <img src="http://mysticalthemes.com/import/meta-store/screen/wine-screenshot.png" alt="<?php echo esc_attr__('Meta Store Demos', 'meta-store'); ?>">
            </div>
        ...
        <div class="recommend-plugins">
            <div class="plug-image">
                <img src="http://mysticalthemes.com/import/meta-store/screen/book-screenshot.png" alt="<?php echo esc_attr__('Meta Store Demos', 'meta-store'); ?>">
            </div>
