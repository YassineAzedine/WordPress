...
! defined( 'WOOSCP_VERSION' ) && define( 'WOOSCP_VERSION', '3.5.7' );
		...
		if ( ! class_exists( 'WPCleverWooscp' ) && class_exists( 'WC_Product' ) ) {
			class WPCleverWooscp {
							...
							<?php if ( $active_tab === 'settings' ) { ?>
                                <form method="post" action="options.php">
                                    ...
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            <th scope="row"><?php esc_html_e( 'Change button text', 'wooscp' ); ?></th>
                                            <td>
                                                ...
                                                <span class="description">
													<?php esc_html_e( 'Change the button text after adding to the compare. If not, only add the class CSS name \'wooscp-btn-added\'.', 'wooscp' ); ?>
												</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><?php esc_html_e( 'Added text', 'wooscp' ); ?></th>
                                            <td>
                                        ...
                                        <tr>
                                            <th scope="row"><?php esc_html_e( 'Bubble', 'wooscp' ); ?></th>
                                            <td>
                                                ...
                                                <span class="description">
													<?php esc_html_e( 'Use the bubble instead of a fully compare bar.', 'wooscp' ); ?>
												</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_wooscp_click_outside">
                                                    ...
                                                    <option
														...
														<?php esc_html_e( 'Yes if empty', 'wooscp' ); ?>
                                                    </option>
                                                    <option
				...
				function wooscp_get_compare_table( $ajax = true ) {
					...
					if ( is_array( $wooscp_products ) && ( count( $wooscp_products ) > 0 ) ) {
						...
						foreach ( $saved_fields as $saved_field ) {
							if ( ! isset( self::$wooscp_fields[ $saved_field ] ) ) {
								continue;
							}
				...
				function wooscp_wp_footer() {
					...
					$wooscp_class .= ' wooscp-bar-' . get_option( '_wooscp_bar_pos', 'bottom' ) . ' wooscp-bar-' . get_option( '_wooscp_bar_align', 'right' ) . ' wooscp-bar-click-outside-' . str_replace( '_', '-', get_option( '_wooscp_click_outside', 'yes' ) );
                            ...
                            <div class="wooscp-bar <?php echo esc_attr( get_option( '_wooscp_bar_bubble', 'no' ) === 'yes' ? 'wooscp-bar-bubble' : '' ); ?>">
								<?php if ( get_option( '_wooscp_click_outside', 'yes' ) !== 'no' && get_option( '_wooscp_bar_bubble', 'no' ) !== 'yes' ) { ?>
                                    <div class="wooscp-bar-notice">
										<?php esc_html_e( 'Click outside to hide the compare bar', 'wooscp' ); ?>
                                    </div>
								<?php }
