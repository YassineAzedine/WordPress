...
class Meta_Store_Slider_Widget extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_responsive_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .ms-slider .ms-slide .ms-slide-content' => 'margin-top: {{SIZE}}{{UNIT}};',
            ],
            'condition' => [
        ...
        $this->add_responsive_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .ms-slider .ms-slide .ms-slide-content' => 'margin-left: {{SIZE}}{{UNIT}};'
            ],
            'condition' => [
                'caption_position' => 'yes',
            ]
    ...
    protected function render() {
        ...
        $slide_height = isset($settings['slide_height']) ? 'ms-slider-height-' . $settings['slide_height'] : 'ms-slider-height-auto';
